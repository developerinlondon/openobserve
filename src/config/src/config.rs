...
pub struct Auth {
    ...
    #[env_config(name = "ZO_TRUSTED_PROXY_AUTH_ENABLED", default = false)]
    pub trusted_proxy_auth_enabled: bool,
    #[env_config(name = "ZO_TRUSTED_PROXY_USER_HEADER", default = "X-Auth-Request-Email")]
    pub trusted_proxy_user_header: String,
    #[env_config(name = "ZO_TRUSTED_PROXY_DEFAULT_ROLE", default = "Admin")]
    pub trusted_proxy_default_role: String,
}
